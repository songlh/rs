...
Our empirical study shows that statically checkable efficiency rules widely exist in software, 
and rules' violations also widely exist. 
...
The first transformation, data streaming, is designed to overlap data transfers to coprocessors
