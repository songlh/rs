...
and log mining tools that can analyze large quantities of logs provided in big data applications.
In order to patch bugs in big data applications, I would like to build automatic fixing tools for big data applications. 
It is time-consuming to run the patched version from very beginning, and I would like to build tools which can help reuse computation already finished in failure runs. 
...
Big data in security areas provides opportunities to leverage data-centric methods to improve today's security techniques. 
...
As another example, by utilizing hung amounts of malware already been studied and labeled by security experts, 
we can learn how malware evolves to quickly detect emerging malware. 
...
%challenges: different platform, different intermediate codes
