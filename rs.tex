...
and many of them escape in-house testing and manifest in front of end users, 
causing severe performance degradation and huge a waste of energy in the field. 
...
My research work has already had real-world impact. 
...
My performance bug fixing project~\cite{Song14MICRO} won runner up for the MICRO'14 best paper, and has also led to an issued patent~\cite{comppatent}.
