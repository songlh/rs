...
Previous work on algorithmic profiling or monitoring will bring more than 10X runtime overhead, which cannot be tolerated in production run.
I would like to build a tool which can collect runtime information in a reasonable overhead and infer approximate complexity from deployed software. 
